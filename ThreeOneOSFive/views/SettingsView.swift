...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    HStack(spacing: 14) {
                        ...
                        VStack(alignment: .leading, spacing: 3) {
                            ...
                            Text(language.text("common.version", appVersion)).font(.subheadline).foregroundStyle(.secondary)
                        }
                    }
                    .padding(.vertical, 4)
                }
            ...
            .confirmationDialog("Tắt tất cả patch?", isPresented: $showResetConfirmation, titleVisibility: .visible) {
            ...
            .alert("TnCheats", isPresented: Binding(get: { resetMessage != nil }, set: { if !$0 { resetMessage = nil } })) {
            ...
            .sheet(isPresented: $showDeveloperKey) {
                NavigationStack {
                    ...
                    .navigationBarTitleDisplayMode(.inline)
                    .toolbar {
                        ToolbarItem(placement: .cancellationAction) { Button("Huỷ") { showDeveloperKey = false } }
